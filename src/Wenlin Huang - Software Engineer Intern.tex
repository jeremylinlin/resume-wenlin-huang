...
%           API endpoints with Node.js, and used MongoDB for data storage}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \resitem
            {Designed and developed a WeChat news pulling/pushing system with Spring
            MVC and Hibernate, and a mobile-friendly news feed with jQuery Mobile}
            \resitem
            {Participated in the development of an EDM (Email Direct Marketing)
            system using Ruby on Rails}
            \resitem
            {Fixed various bugs and cross-browser compatibility issues for our team during
